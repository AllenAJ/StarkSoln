...
fn create_array() -> Array<felt252> {
    let mut a = ArrayTrait::new(); // Use `mut` to make the array mutable
    a.append(0); // The first element should be 0
    a.append(0); // Append two more elements with the value 0
    a.append(0);
    a
}
